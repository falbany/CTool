/**
 * @file ct_ini_test.cpp
 * @author Florent ALBANY - FAL
 * @brief Comprehensive test suite for CTool INI module (ct_ini) using Google Test.
 * @version 1.0
 * @date 2026-05-29
 */
...
class CtIniTest : public ::testing::Test {
  protected:
    ...
    static void SetUpTestSuite() {
        test_dir = fs::temp_directory_path().string() + "/ct_ini_tests";
