        ...
        class Cell {
          public:
            ...
            double asDouble() const {
                ...
                throw std::runtime_error("ctool::data::Cell: Type mismatch. Expected numeric (DOUBLE or INT).");
            }

            int asInt() const {
                if (m_type == INT) return m_i;
                if (m_type == DOUBLE) return static_cast<int>(m_d);
                throw std::runtime_error("ctool::data::Cell: Type mismatch. Expected INT (or DOUBLE).");
            }
            ...
            const std::string& asString() const {
                ...
                throw std::runtime_error("ctool::data::Cell: Type mismatch. Expected STRING.");
            }
