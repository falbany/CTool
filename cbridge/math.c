...
static cbridge_reg_result_t impl_linear_fit(const double* x, const double* y, size_t n) {
...
const struct cbridge_math_namespace cbridge_math = {.linear_fit         = impl_linear_fit,
                                                    .mean               = impl_mean,
