...
namespace ctool {
    namespace data {
        ...
        /**
         * @brief Creates a DataFrame from a ctool::array::Array2D<double>.
         ...
         */
        DataFrame fromArray2D(const ctool::array::Array2D<double>& array, const std::vector<std::string>& columnNames = std::vector<std::string>());

        /**
         * @brief Exports numeric columns to a ctool::array::Array2D<double>.
         * @param df The source DataFrame.
